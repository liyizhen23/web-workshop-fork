...
/** columns and relationships of "meeting_record" */
export type Meeting_Record = {
  __typename?: 'meeting_record';
...
/** aggregated selection of "meeting_record" */
export type Meeting_Record_Aggregate = {
  __typename?: 'meeting_record_aggregate';
  aggregate?: Maybe<Meeting_Record_Aggregate_Fields>;
  nodes: Array<Meeting_Record>;
};

export type Meeting_Record_Aggregate_Bool_Exp = {
  count?: InputMaybe<Meeting_Record_Aggregate_Bool_Exp_Count>;
};

export type Meeting_Record_Aggregate_Bool_Exp_Count = {
  arguments?: InputMaybe<Array<Meeting_Record_Select_Column>>;
  distinct?: InputMaybe<Scalars['Boolean']['input']>;
  filter?: InputMaybe<Meeting_Record_Bool_Exp>;
  predicate: Int_Comparison_Exp;
};

/** aggregate fields of "meeting_record" */
export type Meeting_Record_Aggregate_Fields = {
  __typename?: 'meeting_record_aggregate_fields';
  count: Scalars['Int']['output'];
  max?: Maybe<Meeting_Record_Max_Fields>;
  min?: Maybe<Meeting_Record_Min_Fields>;
};


/** aggregate fields of "meeting_record" */
export type Meeting_Record_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Meeting_Record_Select_Column>>;
  distinct?: InputMaybe<Scalars['Boolean']['input']>;
};

/** order by aggregate values of table "meeting_record" */
export type Meeting_Record_Aggregate_Order_By = {
  count?: InputMaybe<Order_By>;
  max?: InputMaybe<Meeting_Record_Max_Order_By>;
  min?: InputMaybe<Meeting_Record_Min_Order_By>;
};

/** input type for inserting array relation for remote table "meeting_record" */
export type Meeting_Record_Arr_Rel_Insert_Input = {
  data: Array<Meeting_Record_Insert_Input>;
  /** upsert condition */
  on_conflict?: InputMaybe<Meeting_Record_On_Conflict>;
};

/** Boolean expression to filter rows from the table "meeting_record". All fields are combined with a logical 'AND'. */
export type Meeting_Record_Bool_Exp = {
  _and?: InputMaybe<Array<Meeting_Record_Bool_Exp>>;
  _not?: InputMaybe<Meeting_Record_Bool_Exp>;
  _or?: InputMaybe<Array<Meeting_Record_Bool_Exp>>;
...
/** unique or primary key constraints on table "meeting_record" */
export enum Meeting_Record_Constraint {
  /** unique or primary key constraint on columns "uuid" */
  MeetingRecordPkey = 'meeting_record_pkey'
}

/** input type for inserting data into table "meeting_record" */
export type Meeting_Record_Insert_Input = {
...
export type Meeting_Record_Max_Fields = {
  __typename?: 'meeting_record_max_fields';
...
/** order by max() on columns of table "meeting_record" */
export type Meeting_Record_Max_Order_By = {
...
export type Meeting_Record_Min_Fields = {
  __typename?: 'meeting_record_min_fields';
  content?: Maybe<Scalars['String']['output']>;
  created_at?: Maybe<Scalars['timestamp']['output']>;
  room_uuid?: Maybe<Scalars['uuid']['output']>;
  updated_at?: Maybe<Scalars['timestamp']['output']>;
...
/** order by min() on columns of table "meeting_record" */
export type Meeting_Record_Min_Order_By = {
  content?: InputMaybe<Order_By>;
  created_at?: InputMaybe<Order_By>;
  room_uuid?: InputMaybe<Order_By>;
  updated_at?: InputMaybe<Order_By>;
...
/** response of any mutation on the table "meeting_record" */
export type Meeting_Record_Mutation_Response = {
  __typename?: 'meeting_record_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int']['output'];
  /** data from the rows affected by the mutation */
  returning: Array<Meeting_Record>;
};

/** on_conflict condition type for table "meeting_record" */
export type Meeting_Record_On_Conflict = {
  constraint: Meeting_Record_Constraint;
  update_columns?: Array<Meeting_Record_Update_Column>;
  where?: InputMaybe<Meeting_Record_Bool_Exp>;
};

/** Ordering options when selecting data from "meeting_record". */
export type Meeting_Record_Order_By = {
  content?: InputMaybe<Order_By>;
  created_at?: InputMaybe<Order_By>;
...
/** primary key columns input for table: meeting_record */
export type Meeting_Record_Pk_Columns_Input = {
  uuid: Scalars['uuid']['input'];
};

/** select columns of table "meeting_record" */
export enum Meeting_Record_Select_Column {
  /** column name */
  Content = 'content',
  /** column name */
...
/** input type for updating data in table "meeting_record" */
export type Meeting_Record_Set_Input = {
  content?: InputMaybe<Scalars['String']['input']>;
  created_at?: InputMaybe<Scalars['timestamp']['input']>;
  room_uuid?: InputMaybe<Scalars['uuid']['input']>;
  updated_at?: InputMaybe<Scalars['timestamp']['input']>;
...
/** Streaming cursor of the table "meeting_record" */
export type Meeting_Record_Stream_Cursor_Input = {
  /** Stream column input with initial value */
  initial_value: Meeting_Record_Stream_Cursor_Value_Input;
  /** cursor ordering */
  ordering?: InputMaybe<Cursor_Ordering>;
};

/** Initial value of the column from where the streaming should start */
export type Meeting_Record_Stream_Cursor_Value_Input = {
  content?: InputMaybe<Scalars['String']['input']>;
  created_at?: InputMaybe<Scalars['timestamp']['input']>;
  room_uuid?: InputMaybe<Scalars['uuid']['input']>;
  updated_at?: InputMaybe<Scalars['timestamp']['input']>;
...
/** update columns of table "meeting_record" */
export enum Meeting_Record_Update_Column {
  /** column name */
  Content = 'content',
  /** column name */
  CreatedAt = 'created_at',
...
export type Meeting_Record_Updates = {
  /** sets the columns of the filtered rows to the given values */
  _set?: InputMaybe<Meeting_Record_Set_Input>;
  /** filter the rows which have to be updated */
  where: Meeting_Record_Bool_Exp;
};
...
export type Mutation_Root = {
  ...
  /** delete data from the table: "meeting_record" */
  delete_meeting_record?: Maybe<Meeting_Record_Mutation_Response>;
  /** delete single row from the table: "meeting_record" */
  delete_meeting_record_by_pk?: Maybe<Meeting_Record>;
  ...
  /** insert data into the table: "meeting_record" */
  insert_meeting_record?: Maybe<Meeting_Record_Mutation_Response>;
  /** insert a single row into the table: "meeting_record" */
  insert_meeting_record_one?: Maybe<Meeting_Record>;
  ...
  /** update data of the table: "meeting_record" */
  update_meeting_record?: Maybe<Meeting_Record_Mutation_Response>;
  /** update single row of the table: "meeting_record" */
  update_meeting_record_by_pk?: Maybe<Meeting_Record>;
  /** update multiples rows of table: "meeting_record" */
  update_meeting_record_many?: Maybe<Array<Maybe<Meeting_Record_Mutation_Response>>>;
...
/** mutation root */
export type Mutation_RootDelete_Meeting_RecordArgs = {
  where: Meeting_Record_Bool_Exp;
};


/** mutation root */
export type Mutation_RootDelete_Meeting_Record_By_PkArgs = {
  uuid: Scalars['uuid']['input'];
};
...
/** mutation root */
export type Mutation_RootInsert_Meeting_RecordArgs = {
  objects: Array<Meeting_Record_Insert_Input>;
  on_conflict?: InputMaybe<Meeting_Record_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Meeting_Record_OneArgs = {
  object: Meeting_Record_Insert_Input;
  on_conflict?: InputMaybe<Meeting_Record_On_Conflict>;
};
...
/** mutation root */
export type Mutation_RootUpdate_Meeting_RecordArgs = {
  _set?: InputMaybe<Meeting_Record_Set_Input>;
  where: Meeting_Record_Bool_Exp;
};
...
/** mutation root */
export type Mutation_RootUpdate_Meeting_Record_By_PkArgs = {
  _set?: InputMaybe<Meeting_Record_Set_Input>;
  pk_columns: Meeting_Record_Pk_Columns_Input;
};


/** mutation root */
export type Mutation_RootUpdate_Meeting_Record_ManyArgs = {
  updates: Array<Meeting_Record_Updates>;
};
...
export type Query_Root = {
  ...
  /** fetch data from the table: "meeting_record" */
  meeting_record: Array<Meeting_Record>;
  /** fetch aggregated fields from the table: "meeting_record" */
  meeting_record_aggregate: Meeting_Record_Aggregate;
  /** fetch data from the table: "meeting_record" using primary key columns */
  meeting_record_by_pk?: Maybe<Meeting_Record>;
...
export type Query_RootMeeting_RecordArgs = {
  distinct_on?: InputMaybe<Array<Meeting_Record_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Meeting_Record_Order_By>>;
  where?: InputMaybe<Meeting_Record_Bool_Exp>;
};


export type Query_RootMeeting_Record_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Meeting_Record_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Meeting_Record_Order_By>>;
...
export type Query_RootMeeting_Record_By_PkArgs = {
  uuid: Scalars['uuid']['input'];
};
...
export type Room = {
  ...
  meeting_records: Array<Meeting_Record>;
  /** An aggregate relationship */
  meeting_records_aggregate: Meeting_Record_Aggregate;
  /** An array relationship */
...
/** columns and relationships of "room" */
export type RoomMeeting_RecordsArgs = {
  distinct_on?: InputMaybe<Array<Meeting_Record_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Meeting_Record_Order_By>>;
...
/** columns and relationships of "room" */
export type RoomMeeting_Records_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Meeting_Record_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Meeting_Record_Order_By>>;
...
export type Room_Bool_Exp = {
  ...
  meeting_records?: InputMaybe<Meeting_Record_Bool_Exp>;
  meeting_records_aggregate?: InputMaybe<Meeting_Record_Aggregate_Bool_Exp>;
...
export type Room_Insert_Input = {
  ...
  meeting_records?: InputMaybe<Meeting_Record_Arr_Rel_Insert_Input>;
...
export type Room_Order_By = {
  ...
  meeting_records_aggregate?: InputMaybe<Meeting_Record_Aggregate_Order_By>;
...
export type Subscription_Root = {
  ...
  /** fetch data from the table: "meeting_record" using primary key columns */
  meeting_record_by_pk?: Maybe<Meeting_Record>;
  /** fetch data from the table in a streaming manner: "meeting_record" */
  meeting_record_stream: Array<Meeting_Record>;
  /** fetch data from the table: "message" */
  message: Array<Message>;
  /** fetch aggregated fields from the table: "message" */
  message_aggregate: Message_Aggregate;
...
export type Subscription_RootMeeting_RecordArgs = {
  distinct_on?: InputMaybe<Array<Meeting_Record_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Meeting_Record_Order_By>>;
...
export type Subscription_RootMeeting_Record_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Meeting_Record_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Meeting_Record_Order_By>>;
...
export type Subscription_RootMeeting_Record_By_PkArgs = {
  uuid: Scalars['uuid']['input'];
};


export type Subscription_RootMeeting_Record_StreamArgs = {
  batch_size: Scalars['Int']['input'];
  cursor: Array<InputMaybe<Meeting_Record_Stream_Cursor_Input>>;
  where?: InputMaybe<Meeting_Record_Bool_Exp>;
};
...
export type AddMeetingRecordMutationVariables = Exact<{
  room_uuid: Scalars['uuid']['input'];
  content: Scalars['String']['input'];
}>;


export type AddMeetingRecordMutation = { __typename?: 'mutation_root', insert_meeting_record_one?: { __typename?: 'meeting_record', uuid: any, room_uuid: any, content: string, created_at: any, updated_at: any } | null };

export type GetMeetingRecordsByRoomSubscriptionVariables = Exact<{
  room_uuid: Scalars['uuid']['input'];
}>;


export type GetMeetingRecordsByRoomSubscription = { __typename?: 'subscription_root', meeting_record: Array<{ __typename?: 'meeting_record', uuid: any, room_uuid: any, content: string, created_at: any, updated_at: any }> };

export type UpdateMeetingRecordMutationVariables = Exact<{
  uuid: Scalars['uuid']['input'];
  content: Scalars['String']['input'];
  updated_at: Scalars['timestamp']['input'];
}>;


export type UpdateMeetingRecordMutation = { __typename?: 'mutation_root', update_meeting_record_by_pk?: { __typename?: 'meeting_record', uuid: any, content: string, updated_at: any } | null };

export type DeleteMeetingRecordMutationVariables = Exact<{
  uuid: Scalars['uuid']['input'];
}>;


export type DeleteMeetingRecordMutation = { __typename?: 'mutation_root', delete_meeting_record_by_pk?: { __typename?: 'meeting_record', uuid: any } | null };
...
export const AddMeetingRecordDocument = gql`
  ...
  insert_meeting_record_one(object: {room_uuid: $room_uuid, content: $content}) {
    ...
    `;
export type AddMeetingRecordMutationFn = Apollo.MutationFunction<AddMeetingRecordMutation, AddMeetingRecordMutationVariables>;

/**
 * __useAddMeetingRecordMutation__
 *
 * To run a mutation, you first call `useAddMeetingRecordMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddMeetingRecordMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [addMeetingRecordMutation, { data, loading, error }] = useAddMeetingRecordMutation({
 *   variables: {
 ...
 * });
 */
export function useAddMeetingRecordMutation(baseOptions?: Apollo.MutationHookOptions<AddMeetingRecordMutation, AddMeetingRecordMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddMeetingRecordMutation, AddMeetingRecordMutationVariables>(AddMeetingRecordDocument, options);
      }
export type AddMeetingRecordMutationHookResult = ReturnType<typeof useAddMeetingRecordMutation>;
export type AddMeetingRecordMutationResult = Apollo.MutationResult<AddMeetingRecordMutation>;
export type AddMeetingRecordMutationOptions = Apollo.BaseMutationOptions<AddMeetingRecordMutation, AddMeetingRecordMutationVariables>;
export const GetMeetingRecordsByRoomDocument = gql`
...
/**
 * __useGetMeetingRecordsByRoomSubscription__
 *
 * To run a query within a React component, call `useGetMeetingRecordsByRoomSubscription` and pass it any options that fit your needs.
 * When your component renders, `useGetMeetingRecordsByRoomSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMeetingRecordsByRoomSubscription({
 *   variables: {
 *      room_uuid: // value for 'room_uuid'
 *   },
 * });
 */
export function useGetMeetingRecordsByRoomSubscription(baseOptions: Apollo.SubscriptionHookOptions<GetMeetingRecordsByRoomSubscription, GetMeetingRecordsByRoomSubscriptionVariables> & ({ variables: GetMeetingRecordsByRoomSubscriptionVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<GetMeetingRecordsByRoomSubscription, GetMeetingRecordsByRoomSubscriptionVariables>(GetMeetingRecordsByRoomDocument, options);
      }
export type GetMeetingRecordsByRoomSubscriptionHookResult = ReturnType<typeof useGetMeetingRecordsByRoomSubscription>;
export type GetMeetingRecordsByRoomSubscriptionResult = Apollo.SubscriptionResult<GetMeetingRecordsByRoomSubscription>;
export const UpdateMeetingRecordDocument = gql`
  ...
  update_meeting_record_by_pk(
    ...
    `;
export type UpdateMeetingRecordMutationFn = Apollo.MutationFunction<UpdateMeetingRecordMutation, UpdateMeetingRecordMutationVariables>;

/**
 * __useUpdateMeetingRecordMutation__
 *
 * To run a mutation, you first call `useUpdateMeetingRecordMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateMeetingRecordMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateMeetingRecordMutation, { data, loading, error }] = useUpdateMeetingRecordMutation({
 *   variables: {
 *      uuid: // value for 'uuid'
 *      content: // value for 'content'
 ...
 * });
 */
export function useUpdateMeetingRecordMutation(baseOptions?: Apollo.MutationHookOptions<UpdateMeetingRecordMutation, UpdateMeetingRecordMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateMeetingRecordMutation, UpdateMeetingRecordMutationVariables>(UpdateMeetingRecordDocument, options);
      }
export type UpdateMeetingRecordMutationHookResult = ReturnType<typeof useUpdateMeetingRecordMutation>;
export type UpdateMeetingRecordMutationResult = Apollo.MutationResult<UpdateMeetingRecordMutation>;
export type UpdateMeetingRecordMutationOptions = Apollo.BaseMutationOptions<UpdateMeetingRecordMutation, UpdateMeetingRecordMutationVariables>;
export const DeleteMeetingRecordDocument = gql`
  ...
  delete_meeting_record_by_pk(uuid: $uuid) {
    ...
    `;
export type DeleteMeetingRecordMutationFn = Apollo.MutationFunction<DeleteMeetingRecordMutation, DeleteMeetingRecordMutationVariables>;

/**
 * __useDeleteMeetingRecordMutation__
 *
 * To run a mutation, you first call `useDeleteMeetingRecordMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteMeetingRecordMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteMeetingRecordMutation, { data, loading, error }] = useDeleteMeetingRecordMutation({
 *   variables: {
 *      uuid: // value for 'uuid'
 *   },
 * });
 */
export function useDeleteMeetingRecordMutation(baseOptions?: Apollo.MutationHookOptions<DeleteMeetingRecordMutation, DeleteMeetingRecordMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteMeetingRecordMutation, DeleteMeetingRecordMutationVariables>(DeleteMeetingRecordDocument, options);
      }
export type DeleteMeetingRecordMutationHookResult = ReturnType<typeof useDeleteMeetingRecordMutation>;
export type DeleteMeetingRecordMutationResult = Apollo.MutationResult<DeleteMeetingRecordMutation>;
export type DeleteMeetingRecordMutationOptions = Apollo.BaseMutationOptions<DeleteMeetingRecordMutation, DeleteMeetingRecordMutationVariables>;
