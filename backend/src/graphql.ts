...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    addMeetingRecord(variables: AddMeetingRecordMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<AddMeetingRecordMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddMeetingRecordMutation>(AddMeetingRecordDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'addMeetingRecord', 'mutation', variables);
    },
    getMeetingRecordsByRoom(variables: GetMeetingRecordsByRoomSubscriptionVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetMeetingRecordsByRoomSubscription> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMeetingRecordsByRoomSubscription>(GetMeetingRecordsByRoomDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getMeetingRecordsByRoom', 'subscription', variables);
    },
    updateMeetingRecord(variables: UpdateMeetingRecordMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdateMeetingRecordMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateMeetingRecordMutation>(UpdateMeetingRecordDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'updateMeetingRecord', 'mutation', variables);
    },
    deleteMeetingRecord(variables: DeleteMeetingRecordMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteMeetingRecordMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteMeetingRecordMutation>(DeleteMeetingRecordDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'deleteMeetingRecord', 'mutation', variables);
    },
